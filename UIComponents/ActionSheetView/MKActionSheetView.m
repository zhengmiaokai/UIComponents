...
- (void)createSubViews {
    ...
    buttonView.backgroundColor = [UIColor colorWithHexString:@"#FFFFFF"];
    ...
    for (int i=0; i<_buttonTitles.count; i++) {
        ...
        [button setTitle:[_buttonTitles safeObjectAtIndex:i] forState:UIControlStateNormal];
        ...
        if (i>0) {
            ...
            lineView.backgroundColor = [UIColor colorWithHexString:@"#000000" alpha:0.08];
